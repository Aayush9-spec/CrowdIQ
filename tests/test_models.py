...
def test_zone_creation():
    ...
    zone = Zone(id="test-z1", name="Test Zone", capacity=1000, type="seating", lat=0.0, lng=0.0)
...
def test_zone_occupancy():
    ...
    zone = Zone(id="test-z2", name="Test Zone 2", capacity=500, type="food_court", lat=0.0, lng=0.0)
